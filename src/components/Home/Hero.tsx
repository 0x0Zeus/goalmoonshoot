const Hero = () => {
  return (
    <div className="hero-bg pb-12 sm:pb-[60px] md:pb-[90px] lg:pb-[135px] pt-[100px] mt-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4 sm:space-y-5">
        <h1 className="font-inter font-black text-4xl sm:text-5xl md:text-[80px] lg:text-[100px] leading-tight sm:leading-[64px] md:leading-[90px] lg:leading-[120px] text-[#C6A353] hero-title">
          KONG Blog
        </h1>
